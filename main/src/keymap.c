...
static key_t layout[2][MATRIX_ROWS][MATRIX_COLS] = {
    // right half
    {
        ...
        { K(KEY_ENTER), K(KEY_LAYER), K(KEY_BSLSH),  K(KEY_EQUAL), K(KEY_NONE)  },
    ...
    // left half
    {
        ...
        { K(KEY_NONE), K(KEY_LBRKT), K(KEY_RBRKT), K(KEY_LAYER), K(KEY_SPACE) },
...
static key_t layer_1[2][MATRIX_ROWS][MATRIX_COLS] = {
    // right half
    {
        ...
        { K(KEY_KP_ENTER), K(KEY_LAYER),K(KEY_KP_0), K(KEY_KP_DOT), K(KEY_NONE) },
        { K(KEY_RGUI),     K(KEY_LAYER),K(KEY_NONE),  K(KEY_NONE),   K(KEY_NONE) },
    },
    // left half
    {
        ...
        { K(KEY_NONE), K(KEY_NONE),  K(KEY_NONE),  K(KEY_NONE),  K(KEY_NONE)  },
        { K(KEY_NONE), K(KEY_LBRKT), K(KEY_RBRKT), K(KEY_LAYER), K(KEY_BKSP)  },
...
static key_t layer_2[2][MATRIX_ROWS][MATRIX_COLS] = {
    // right half
    {
        ...
        { K(KEY_ENTER),K(KEY_LAYER),K(KEY_NONE), K(KEY_NONE), K(KEY_NONE) },
        { K(KEY_RGUI), K(KEY_RALT), K(KEY_NONE), K(KEY_NONE), K(KEY_NONE) },
    },
    // left half
    {
...
static key_t layer_3[2][MATRIX_ROWS][MATRIX_COLS] = {
    // right half — transparent
    {
        ...
        { K(KEY_NONE), K(KEY_NONE), K(KEY_NONE), K(KEY_NONE), K(KEY_NONE) },
        { K(KEY_NONE), K(KEY_NONE), K(KEY_NONE), K(KEY_NONE), K(KEY_NONE) },
        { K(KEY_NONE), K(KEY_LAYER),K(KEY_NONE),  K(KEY_NONE), K(KEY_NONE) },
        { K(KEY_NONE), K(KEY_NONE), K(KEY_NONE),  K(KEY_NONE), K(KEY_NONE) },
    },
    // left half — F1-F12 across finger rows
    {
        ...
        { K(KEY_NONE), K(KEY_NONE), K(KEY_NONE),K(KEY_LAYER), K(KEY_NONE) },
        { K(KEY_NONE), K(KEY_NONE), K(KEY_NONE),K(KEY_LSHIFT),K(KEY_LCTRL) },
    }
};

static key_t blank[2][MATRIX_ROWS][MATRIX_COLS] = {0};
